...
opencode-plugin-check:
    ...
    repo="$PWD"; scratch=/tmp/opencode/kmux-plugin-check; mkdir -p "$scratch"; cd "$scratch" && bun build "$repo/integrations/opencode/kmux-select-session.ts" --target bun --outfile "$scratch/kmux-select-session-check.js"
